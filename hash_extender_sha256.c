...
uint8_t *sha256_append_data(uint8_t *data, size_t data_length, size_t secret_length, uint8_t *append, size_t append_length, size_t *new_length)
{
...
void sha256_gen_signature(uint8_t *secret, size_t secret_length, uint8_t *data, size_t data_length, uint8_t signature[SHA256_DIGEST_LENGTH])
{
  SHA256_CTX c;
  SHA256_Init(&c);
...
void sha256_gen_signature_evil(size_t secret_length, size_t data_length, uint8_t original_signature[SHA256_DIGEST_LENGTH], uint8_t *append, size_t append_length, uint8_t new_signature[SHA256_DIGEST_LENGTH])
{
  SHA256_CTX c;
...
static int sha256_test_validate(uint8_t *secret, size_t secret_length, uint8_t *data, size_t data_length, uint8_t *signature)
{
