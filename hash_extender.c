...
int main()
{
  ...
  printf("md5_test_evil_signature_generation:\n");
  md5_test_evil_signature_generation();
  printf("\n-----------------------------------------------------\n\n");
  printf("md5_test_normal_signture_generation:\n");
  md5_test_normal_signture_generation();
  printf("\n-----------------------------------------------------\n\n");
