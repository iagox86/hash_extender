...
void test_different_length_data()
{
...
void test_different_length_append()
{
...
int main()
{
  ...
  printf("\n-----------------------------------------------------\n\n");
  printf("test_different_length_data:\n");
  test_different_length_data();
  printf("\n-----------------------------------------------------\n\n");
  printf("test_different_length_append:\n");
  test_different_length_append();
